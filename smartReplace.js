...
function batchReplace() {
	...
	remoteContent = remoteContent.replace(new RegExp(process.env.PHRE, "g"), 'JUSTWORKHARD');
	remoteContent = remoteContent.replace(new RegExp(process.env.HPRE, "g"), 'false');
...
async function download(url, path, target) {
    ...
    fcontent = fcontent.replace(new RegExp(process.env.PHRE, "g"), 'JUSTWORKHARD');
