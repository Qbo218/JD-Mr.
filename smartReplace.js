...
async function downloader_jd() {
    if (/require\(['"`]{1}.\/jdCookie.js['"`]{1}\)/.test(remoteContent))
        await download("https://github.com/MisterGlasses/Quantumult/raw/master/QuantumultX/jdCookie.js", "./jdCookie.js", "京东Cookies");
    if (remoteContent.indexOf("jdFruitShareCodes") > 0) {
        await download(
            "https://github.com/MisterGlasses/jd_scripts/raw/master/jdFruitShareCodes.js",
    ...
    if (remoteContent.indexOf("jdPlantBeanShareCodes") > 0) {
        await download(
            "https://github.com/MisterGlasses/jd_scripts/raw/master/jdPlantBeanShareCodes.js",
    ...
    if (remoteContent.indexOf("new Env('京喜农场')") > 0) {
        await download(
            "https://github.com/MisterGlasses/jd_scripts/raw/master/jdJxncTokens.js",
            "./jdJxncTokens.js",
            "京喜农场Token"
        );
        await download(
            "https://github.com/MisterGlasses/jd_scripts/raw/master/jdJxncShareCodes.js",
            "./jdJxncShareCodes.js",
            "京喜农场分享码"
        );
        await download(
            "https://github.com/MisterGlasses/jd_scripts/raw/master/USER_AGENTS.js",
            "./USER_AGENTS.js",
            "USER_AGENTS"
        );
    }
    if (remoteContent.indexOf("logShareCodes") > 0) {
        await download(
...
async function downloader_notify() {
    await download("https://github.com/MisterGlasses/jd_scripts/raw/master/sendNotify.js", "./sendNotify.js", "统一通知");
}

async function downloader_user_agents() {
    await download("https://github.com/MisterGlasses/jd_scripts/raw/master/USER_AGENTS.js", "./USER_AGENTS.js", "云端UA");
}
